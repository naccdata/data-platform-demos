...
def build_qc_rows(file_object: FileOutput, insert_row: Callable[[Dict[str, Any], str, List[Dict[str,Any]]], None]) -> List[Dict[str, Any]]:
...
def build_error_rows(file_object: FileOutput) -> List[Dict[str, Any]]:
    ...
    """
    def insert_error_row(qc_object: Dict[str, Any], gear_name: str, table: List[Dict[str, Any]]) -> None:
...
def build_status_rows(file_object: FileOutput) -> List[Dict[str, Any]]:
    def insert_status_row(qc_object: Dict[str, Any], gear_name: str, table: List[Dict[str,Any]]) -> None:
        table.append({
            'name': file_object.name,
            'id': file_object.id,
            'gear': gear_name,
...
def get_qc_data(project: Project, row_builder: Callable[[FileOutput], List[Dict[str,Any]]]) -> List[Dict[str, Any]]:
