"""Example uploader script for submitting enrollment data to NACC Data Platform."""
...
def main():
    """Upload an enrollment CSV file to the NACC Data Platform."""
    parser = argparse.ArgumentParser(description="Upload enrollment CSV file")
    parser.add_argument(
        "-a",
        "--adcid",
